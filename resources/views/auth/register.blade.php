            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="breadcrumb-wrapper">
                        <h2 class="page-title"> {{ __('register_new_acc') }} </h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        {{ Form::open(['method' => 'post']) }}
                            <div class="form-group error-form">
                                <div class="input-icon @if($errors->has('name')) error-input @endif">
                                    ...
                                    {{ Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'placeholder' => __('your_name')]) }}
                                </div>
                            ...
                            <div class="form-group error-form">
                                <div class="input-icon @if($errors->has('email')) error-input @endif">
                                    ...
                                    {{ Form::text('email', null, ['class' => 'form-control', 'id' => 'email', 'placeholder' => __('your_email')]) }}
                                </div>
                            ...
                            <div class="form-group error-form">
                                <div class="input-icon @if($errors->has('password')) error-input @endif">
                                    ...
                                    {{ Form::password('password', ['class' => 'form-control', 'id' => 'password', 'placeholder' => __('your_password')]) }}
                                </div>
                            ...
                            <div class="form-group error-form">
                                <div class="input-icon @if($errors->has('password_confirmation')) error-input @endif">
                                    <i class="icon fa fa-unlock-alt"></i>
                                    {{ Form::password('password_confirmation', ['class' => 'form-control', 'id' => 'password-confirmation', 'placeholder' => __('your_password_confirmation')]) }}
                                </div>
                                <p>{{ $errors->first('password') }}</p>
                            </div>
                            <div class="form-group error-form">
